...
func (p *printer) expr1(expr ast.Expr, prec1, depth int) {
	...
	case *ast.TypeParam:
		...
		p.expr(x.Name)
		if x.Restriction == ast.RestrictionEq {
			p.print(blank, "eq")
		}
		if x.Restriction&ast.RestrictionOrd != 0 {
			p.print(blank, "ord")
		}
		if x.Restriction&ast.RestrictionNum != 0 {
			p.print(blank, "num")
		}
